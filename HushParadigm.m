%% HUSH TASK WITH LSL MARKERS
% ----------------------------
% This task involves the participant performing either CanineClench or
% TongueTap. An LSL marker is sent during this period.
...
text2show = 'Press';                % sound participant must make

nTrials = 50;                       % total number of trials
